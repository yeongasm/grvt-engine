...
namespace Grvt
{
	...
	*/
	...
	public:
		...
		*/
		bool SetBool(const Gfl::String& Uniform, bool Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetInt(const Gfl::String& Uniform, int Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetFloat(const Gfl::String& Uniform, float Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetVector(const Gfl::String& Uniform, glm::vec2 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetVector(const Gfl::String& Uniform, glm::vec3 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetVector(const Gfl::String& Uniform, glm::vec4 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetMatrix(const Gfl::String& Uniform, glm::mat2 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetMatrix(const Gfl::String& Uniform, glm::mat3 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetMatrix(const Gfl::String& Uniform, glm::mat4 Value);
		...
		* Returns false if uniform with the specified name is not found.
		*/
		bool SetTexture(const Gfl::String& Uniform, GrvtTexture* Texture);
	};
