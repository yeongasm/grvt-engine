...
int main() {
	...
	FloatingPinArray fpa;
	fpa.Alloc(3, 3);
	fpa.Block[0].Push(FloatingPin(1, 0));
	fpa.Block[1].Push(FloatingPin(1, 0));
	fpa.Block[3].Push(FloatingPin(1, 0));
	fpa.Block[4].Push(FloatingPin(3, 0));
